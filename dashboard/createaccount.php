...
$fonction=$_SESSION["fonction"];
        if(isset($_POST["email"])){
            ...
            echo"<script>alert('compte créé avec succes')</script>";
            }
            else{
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="./createaccount.php">Creation de compte</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h5 class="text-center">creer un compte</h5>
                                    <div class="mb-3">
                                         <label for="exampleFormControlInput1" class="form-label">nom:</label>
                                         <input type="text" class="form-control" name="nom" id="exampleFormControlInput1" placeholder="nom" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">prenom:</label>
                                        <input type="text" class="form-control" name="prenom" id="exampleFormControlInput1" placeholder="prenom" required>
                                   </div>
                                   <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">email:</label>
                                    <input type="email" class="form-control" name="email" id="exampleFormControlInput1" placeholder="user@email.com" required>
                               </div>
                               <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">mot de passe:</label>
                                <input type="password" class="form-control" name="mdp" id="exampleFormControlInput1" placeholder="mot de passe" required>
                           </div>
                           <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Confirmer mot de passe:</label>
                            <input type="password" class="form-control" name="mot de passe" id="exampleFormControlInput1" placeholder="mot de passe" required>
                       </div>
                       <center>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; LPAOSF 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
