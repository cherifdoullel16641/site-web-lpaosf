...
$requete = $bdd->prepare("UPDATE users SET mdp = ? WHERE login=?");
$requete->execute([$_POST["mdp"],$_POST["email"]]);
echo"<script>alert('mot de passe modifié avec succes')</script>";
}
else{
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse active" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="./forgotPassword.php">Mot de passe oublié</a>
                    </div>
                </div>
            </li>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" class="bg-white container"><br>
                        <h5 class="text-center">mot de passe oublié</h5>
                                   ...
                                   <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control" name="" id="exampleFormControlInput1" placeholder="mot de passe" required>
                               </div>
                               <div class="mb-3">
