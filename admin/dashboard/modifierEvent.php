<?php 
    ...
    try {
        ...
        if (isset($_POST['name'], $_POST['description'], $_POST['date'])) {
            $stmt = $conn->prepare("UPDATE events SET name ='".$_POST['name']."', description='".$_POST['description']."', date='".$_POST['date']."',heure='".$_POST['heure']."' WHERE idEvent = ".$_GET['id']);
            $stmt->execute();
            ...
            <div class="">
                ...
                <form action="" method="post">
                 ...
                 <div class="form-group">
                        ...
                        <select name="name" id="" class="container-fluid">
                            <option value="<?php if($result) echo $result['name']; ?>"><?php if($result) echo $result['name']; ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="date" name="heure" value="" placeholder="" required>
                    </div>
                    <div class="form-group">
                        <label for="description">Description</label>
                        <textarea class="form-control" id="description" name="description" rows="3" required><?php if($result) echo $result['description']; ?></textarea>
                    </div>
