...
if (isset($_POST['name'], $_POST['description'], $_POST['date'])) {
    if (!empty($_POST['name']) && !empty($_POST['description']) && !empty($_POST['date'])) {
        $stmt = $bdd->prepare("INSERT INTO events (name,description,date,heure) VALUES (?,?,?,?)");
        $stmt->execute((array($_POST['name'],$_POST['description'],$_POST['date'],$_POST['heure'])));
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="time" class="form-control" id="date" name="heure" value="" placeholder="">
                    </div>
                    <div class="form-group">
