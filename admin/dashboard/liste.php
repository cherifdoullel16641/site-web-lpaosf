<?php 
    ...
    try {
        ...
        foreach ($result as $row) {
            ...
            $list.= '<td>'.$row['date'].'</td>';
            $list.= '<td>'.$row['heure'].'</td>';
            $list.= '<td><button class="btn btn-primary"> <a class='."text-white".' href="./modifierEvent.php?id='.$row['idEvent'].'">Modifier</a></button> </td>';
            $list.= '<td> <button class="btn btn-danger"><a class='."text-white".' href="drop.php?id='.$row['idEvent'].'">Supprimer</a></button> </td>';
            $list.= '</tr>';
        }
